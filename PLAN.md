...
- [x] nested-and-layered: a `.gitignore` in a subdirectory overrides its parent, and `.git/info/exclude` and `core.excludesFile` layer beneath both. An excluded directory cannot be re-included by negating a file inside it. Slice: `corpus/nested-and-layered` - swept at 0da19fcc2298cddfd28ae483f405f952e8f507f5 - 11 cases, 23 queries, all agreeing with the oracle
