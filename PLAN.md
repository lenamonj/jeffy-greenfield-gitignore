...
- [x] anchoring: a pattern with a non-trailing `/` is relative to the `.gitignore` location; otherwise it matches at any depth. Slice: `corpus/anchoring` - swept at 74fcc8bcaceb19c1fca5ab651f0ee7299b209ee0 - 9 cases, 23 queries, all agreeing with the oracle
...
- [x] nested-and-layered: a `.gitignore` in a subdirectory overrides its parent, and `.git/info/exclude` and `core.excludesFile` layer beneath both. An excluded directory cannot be re-included by negating a file inside it. Slice: `corpus/nested-and-layered` - swept at d21d01a082e29ad17195b83a84c33978df2f7d75 - 13 cases, 31 queries, all agreeing with the oracle
