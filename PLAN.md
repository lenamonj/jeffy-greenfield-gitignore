...
- [x] nested-and-layered: a `.gitignore` in a subdirectory overrides its parent, and `.git/info/exclude` and `core.excludesFile` layer beneath both. An excluded directory cannot be re-included by negating a file inside it. Slice: `corpus/nested-and-layered` - swept at 22b309a5746d0d6031016b4587a06825fce43210 - 12 cases, 26 queries, all agreeing with the oracle
